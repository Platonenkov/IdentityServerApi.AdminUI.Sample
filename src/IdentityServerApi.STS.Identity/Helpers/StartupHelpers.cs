...
using IdentityServerApi.STS.Identity.Configuration;
using IdentityServerApi.STS.Identity.Configuration.ApplicationParts;
using IdentityServerApi.STS.Identity.Configuration.Constants;
using IdentityServerApi.STS.Identity.Configuration.Interfaces;
using IdentityServerApi.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace IdentityServerApi.STS.Identity.Helpers
{
